...
_VK_ERROR_HINTS = {
    5: "Токен ВК недействителен или истёк. Получи новый community access token и обнови .env.",
    7: "У токена нет прав на это действие. Нужны права wall, photos, video.",
    9: "Превышен лимит публикаций. Подожди и попробуй снова.",
    14: "VK требует капчу. Попробуй чуть позже.",
    15: "Доступ запрещён. Проверь, что токен сообщества и ты — админ группы.",
    100: "Один из параметров VK API не принят (обычно неверный group_id или формат).",
    214: "Запись на стене недоступна (попробуй права wall в токене).",
}
